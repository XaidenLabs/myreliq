...
export const heroStickers = [
  { label: "Roles", icon: "loop" },
  { label: "Timeline", icon: "clock" },
  { label: "Projects", icon: "spark" },
...
export const solutionCards = [
  {
    title: "Instant Setup",
    description: "Launch your public proof-of-work hub in under five minutes.",
  },
  {
...
export const stepCards = [
  ...
  },
  {
    ...
    description: "One link that shows your journey end-to-end.",
  },
];
...
export const testimonials = [
  {
    name: "Aisha Bello",
    title: "Product Intern, Lagos",
    quote:
      "Myreliq helped me show more than polished screenshots. Recruiters finally see the messy middle.",
  },
  {
    name: "Kwame Ofori",
...
export const faqs = [
  {
    ...
    answer: "Nope. Myreliq templates are done-for-you and editable on mobile.",
  },
  {
    question: "Is my profile public?",
    answer: "Keep it private until it's tight. Publish when you are ready.",
  },
  {
    question: "Can I import projects from Notion?",
    answer: "Drag media, embed links, or paste markdown - your call.",
  },
  {
    question: "How fast can I get set up?",
    answer: "Launch a polished proof-of-work hub in less than ten minutes.",
  },
  {
    question: "Does Myreliq work on mobile?",
    answer: "Yes. Every surface is responsive-first for quick edits on the go.",
  },
];
