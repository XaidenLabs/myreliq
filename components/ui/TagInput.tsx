        ...
        <div>
            ...
            <div className="relative flex items-center gap-2">
                <input
                    ...
                    className="flex-1 rounded-xl border border-[#1f1e2a]/10 bg-[#fef7f5] px-4 py-3 font-semibold text-[#1f1e2a] focus:border-[#ff4c2b] focus:outline-none focus:ring-1 focus:ring-[#ff4c2b]"
                    value={input}
                ...
                <button
                    ...
                    onClick={addTag}
                    disabled={!input.trim()}
                    className="rounded-xl bg-[#1f1e2a] px-4 py-3 text-sm font-bold text-white shadow-lg hover:bg-[#3d3b4d] active:scale-95 transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    Add
                </button>
            </div>
